...
use rustic::app::commands::{Command, LiveCommand, LoopCommand, MixCommand, SettingsCommand};
...
impl KeyMapper {
    ...
    fn map_key_press(&self, key: &Keycode) -> Option<Command> {
        match key {
            ...
            // Volume controls
            Keycode::Up => Some(Command::Mix(MixCommand::VolumeUp(0))),
            Keycode::Down => Some(Command::Mix(MixCommand::VolumeDown(0))),

            // Metronome controls
            Keycode::M => Some(Command::Settings(SettingsCommand::ToggleMetronome)),

            // Loop recording controls
            Keycode::Space => Some(Command::Loop(LoopCommand::PlayLoop)),
            Keycode::Escape => Some(Command::Loop(LoopCommand::StopLoop)),
    ...
    fn map_key_release(&self, key: &Keycode) -> Option<Command> {
        match key {
            Keycode::Key1 => Some(Command::Live(LiveCommand::NoteStop { note: 0, row: 0 })),
            Keycode::Key2 => Some(Command::Live(LiveCommand::NoteStop { note: 1, row: 0 })),
            Keycode::Key3 => Some(Command::Live(LiveCommand::NoteStop { note: 2, row: 0 })),
            Keycode::Key4 => Some(Command::Live(LiveCommand::NoteStop { note: 3, row: 0 })),
            Keycode::Key5 => Some(Command::Live(LiveCommand::NoteStop { note: 4, row: 0 })),
            Keycode::Key6 => Some(Command::Live(LiveCommand::NoteStop { note: 5, row: 0 })),
            Keycode::Key7 => Some(Command::Live(LiveCommand::NoteStop { note: 6, row: 0 })),
            Keycode::Key8 => Some(Command::Live(LiveCommand::NoteStop { note: 7, row: 0 })),
            Keycode::Key9 => Some(Command::Live(LiveCommand::NoteStop { note: 8, row: 0 })),
            Keycode::Key0 => Some(Command::Live(LiveCommand::NoteStop { note: 9, row: 0 })),
            Keycode::Minus => Some(Command::Live(LiveCommand::NoteStop { note: 9, row: 0 })),
            Keycode::Equal => Some(Command::Live(LiveCommand::NoteStop { note: 9, row: 0 })),

            Keycode::Q => Some(Command::Live(LiveCommand::NoteStop { note: 0, row: 1 })),
            Keycode::W => Some(Command::Live(LiveCommand::NoteStop { note: 1, row: 1 })),
            Keycode::E => Some(Command::Live(LiveCommand::NoteStop { note: 2, row: 1 })),
            Keycode::R => Some(Command::Live(LiveCommand::NoteStop { note: 3, row: 1 })),
            Keycode::T => Some(Command::Live(LiveCommand::NoteStop { note: 4, row: 1 })),
            Keycode::Y => Some(Command::Live(LiveCommand::NoteStop { note: 5, row: 1 })),
            Keycode::U => Some(Command::Live(LiveCommand::NoteStop { note: 6, row: 1 })),
            Keycode::I => Some(Command::Live(LiveCommand::NoteStop { note: 7, row: 1 })),
    ...
    fn map_key_with_shift(&self, key: &Keycode) -> Option<Command> {
        match key {
            Keycode::Z => Some(Command::Live(LiveCommand::OctaveDown(0))),
            Keycode::X => Some(Command::Live(LiveCommand::OctaveDown(1))),

            // Volume controls with shift
            Keycode::Up => Some(Command::Mix(MixCommand::VolumeUp(1))),
            Keycode::Down => Some(Command::Mix(MixCommand::VolumeDown(1))),
