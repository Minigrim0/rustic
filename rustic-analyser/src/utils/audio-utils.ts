 ...
 */
export function normalizeSamples(samples: Array<number>) {
 ...
 */
export function calculateRmsLevel(samples: Array<number>) {
 ...
 */
export function findPeakFrequency(frequencies: Array<[number, number]>) {
 ...
 */
export function processArrayBuffer(buffer: ArrayBuffer) {
